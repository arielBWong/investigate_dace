function[best_x, info] = switchEIM_gpr(train_x, train_y, xu_bound, xl_bound, ...
                                 num_pop, num_gen, train_c, fitnesshn, normhn, kriging_obj, kriging_con)
...
if ~isempty(train_c)
    ...
    if sum(index_c) == 0 % no feasible
        ...
        index_p = Paretoset(feasible_trainy_norm);  % compatible with SO and MO
